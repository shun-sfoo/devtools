...
use sqlparser::ast::{OrderByExpr, Select, SetExpr, Statement, TableFactor};

use sqlparser::ast::{
    BinaryOperator as SqlBinaryOperator, Expr as SqlExpr, Offset as SqlOffset, SelectItem,
...
impl<'a> TryFrom<Source<'a>> for &'a str {
    ...
    fn try_from(source: Source<'a>) -> Result<Self, Self::Error> {
        ...
        if !table.joins.is_empty() {
            return Err(anyhow!("We do not support at the moment"));
        }
